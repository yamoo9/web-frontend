...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      }, this.state.email.label), React.createElement(FormControl, {
        id: this.state.password.id,
        type: this.state.password.type
      }, this.state.password.label), React.createElement(RequestButton, null, "\uC0AC\uC6A9\uC790 \uC815\uBCF4 \uC694\uCCAD"), React.createElement("div", {
        style: {
          width: 420
        }
